...
function TLoggerGlobals() {
	...
	loader.loadSubScript("chrome://tabviz/content/json2.min.js");
	...
	function getScreenshotDir(create) {
		var MY_ID = "tabviz@tabviz.org";
		var em = Components.classes["@mozilla.org/extensions/manager;1"].getService(Components.interfaces.nsIExtensionManager);
		var dir = em.getInstallLocation(MY_ID).getItemFile(MY_ID, "/content/screenshots");
	...
	function getScreenshotDirFile(filename, create) {
		var file = getScreenshotDir(create);
		file.append(filename);
	...
	this.getScreenshotDirFile = getScreenshotDirFile;
